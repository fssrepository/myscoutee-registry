...
func TestSchemaEnablesWALAndAppendOnlyTriggers(t *testing.T) {
	...
	expectedTriggers := []string{
		...
		"revenue_batches_no_update", "revenue_batches_no_delete",
		"revenue_query_rows_no_update", "revenue_query_rows_no_delete",
		"settlements_no_update", "settlements_no_delete",
		"settlement_revenue_sources_no_update", "settlement_revenue_sources_no_delete",
		"settlement_ttm_months_no_update", "settlement_ttm_months_no_delete",
		"settlement_weight_sources_no_update", "settlement_weight_sources_no_delete",
		"settlement_beneficiary_deployments_no_update", "settlement_beneficiary_deployments_no_delete",
		"settlement_allocations_no_update", "settlement_allocations_no_delete",
		...
		"exit_reviews_no_update", "exit_reviews_no_delete",
		"exit_review_deployments_no_update", "exit_review_deployments_no_delete",
